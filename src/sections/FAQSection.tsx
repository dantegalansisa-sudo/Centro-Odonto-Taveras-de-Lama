...
const content: Record<Lang, {
  ...
  es: {
    ...
    faqs: [
      { question: '¿Cuánto cuesta un diseño de sonrisa?', answer: 'El costo varía según el caso. Realizamos una evaluación inicial donde analizamos tu situación y te presentamos un plan de tratamiento con precio exacto.' },
      ...
      { question: '¿Qué formas de pago aceptan?', answer: 'Aceptamos efectivo y todas las tarjetas de crédito y débito (VISA, Mastercard y American Express).' },
  ...
  en: {
    ...
    faqs: [
      { question: 'How much does a smile design cost?', answer: 'The cost varies by case. We carry out an initial evaluation where we analyze your situation and present a treatment plan with an exact price.' },
      ...
      { question: 'What payment methods do you accept?', answer: 'We accept cash and all credit and debit cards (VISA, Mastercard and American Express).' },
  ...
  fr: {
    ...
    faqs: [
      { question: 'Combien coûte une conception du sourire ?', answer: "Le coût varie selon le cas. Nous réalisons une évaluation initiale au cours de laquelle nous analysons votre situation et vous présentons un plan de traitement avec un prix exact." },
      ...
      { question: 'Quels moyens de paiement acceptez-vous ?', answer: 'Nous acceptons les espèces et toutes les cartes de crédit et de débit (VISA, Mastercard et American Express).' },
