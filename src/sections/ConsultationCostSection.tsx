...
const content: Record<Lang, {
  ...
  es: {
    ...
    lead: 'La consulta inicial tiene un costo de US$30 / €30. Lo mejor: ese monto se descuenta del costo total de tu tratamiento. No es un gasto, es el primer abono a tu nueva sonrisa.',
    steps: [
      ...
      { num: '03', title: 'Se descuenta del total', desc: 'Los US$30 / €30 se abonan al costo de tu procedimiento.' },
    ],
  ...
  en: {
    ...
    lead: 'The initial consultation costs US$30 / €30. The best part: that amount is deducted from the total cost of your treatment. It is not an expense — it is the first payment toward your new smile.',
    steps: [
      ...
      { num: '03', title: 'Deducted from the total', desc: 'The US$30 / €30 is applied to the cost of your procedure.' },
    ],
  ...
  fr: {
    ...
    lead: "La consultation initiale coûte 30 US$ / 30 €. Le meilleur : ce montant est déduit du coût total de votre traitement. Ce n'est pas une dépense, c'est le premier versement vers votre nouveau sourire.",
    steps: [
      ...
      { num: '03', title: 'Déduit du total', desc: 'Les 30 US$ / 30 € sont appliqués au coût de votre intervention.' },
    ],
