      ...
      <div className="section-container">
        ...
        >
          ...
          <div className="footer__social">
            <a href="https://www.instagram.com/odontotavedlama" target="_blank" rel="noopener noreferrer" className="footer__social-link interactive" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/odontotavedlama" target="_blank" rel="noopener noreferrer" className="footer__social-link interactive" aria-label="Facebook">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
              </svg>
            </a>
            <a href="https://www.youtube.com/@centroodontologicodralilia8626" target="_blank" rel="noopener noreferrer" className="footer__social-link interactive" aria-label="YouTube">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
