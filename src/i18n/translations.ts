...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'booking.submit': 'Enviar solicitud por email →',
    'booking.sent': '¡Listo! Revisa tu correo',
    'booking.or': 'o',
  ...
  en: {
    ...
    'booking.submit': 'Send request by email →',
    'booking.sent': 'Done! Check your email',
    'booking.or': 'or',
  ...
  fr: {
    ...
    'booking.submit': 'Envoyer la demande par e-mail →',
    'booking.sent': 'Terminé ! Vérifiez votre e-mail',
    'booking.or': 'ou',
